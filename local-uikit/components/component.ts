...
import { EventHandlersProperties } from '../../submodules/uikit/packages/uikit/src/events.ts'
import {
  BufferGeometry,
  Intersection,
  Material,
...
import {
  ...
  setupPointerEvents,
} from '../../submodules/uikit/packages/uikit/src/utils.ts'
import {
  computedPanelMatrix,
  InstancedPanelMesh,
  makeClippedCast,
...
import { computedIsClipped } from '../../submodules/uikit/packages/uikit/src/clipping.ts'
import { FlexNode, Inset } from '../../submodules/uikit/packages/uikit/src/flex/node.ts'
import { OrderInfo } from '../../submodules/uikit/packages/uikit/src/order.ts'
import { allAliases } from '../../submodules/uikit/packages/uikit/src/properties/alias.ts'
import { type Conditionals, createConditionals } from '../../submodules/uikit/packages/uikit/src/properties/conditional.ts'
import {
  BaseOutProperties,
  InProperties,
  Properties,
  ...
  WithSignal,
} from '../../submodules/uikit/packages/uikit/src/properties/index.ts'
import { computedTransformMatrix } from '../../submodules/uikit/packages/uikit/src/transform.ts'
import { setupCursorCleanup } from '../../submodules/uikit/packages/uikit/src/hover.ts'
import { ClassList, getStarProperties, StyleSheet } from '../../submodules/uikit/packages/uikit/src/components/classes.ts'
import { InstancedGlyphMesh } from '../../submodules/uikit/packages/uikit/src/text/index.ts'
import { buildRootContext, buildRootMatrix, RenderContext, RootContext } from '../context.ts'
import { inheritedPropertyKeys } from '../../submodules/uikit/packages/uikit/src/properties/inheritance.ts'
import type { Container } from './container.ts'
import { componentDefaults } from '../../submodules/uikit/packages/uikit/src/properties/defaults.ts'
import { getLayerIndex } from '../../submodules/uikit/packages/uikit/src/properties/layer.ts'
